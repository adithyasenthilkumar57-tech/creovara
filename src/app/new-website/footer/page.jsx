...
export default function Footer() {
    return (
        <footer className="bg-black text-white p-12 md:p-24 border-t border-zinc-900">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-20">
                ...
                <div className="mt-12 md:mt-0 flex flex-col space-y-4 text-right">
                    ...
                    <a href="mailto:hello@void.fashion" className="text-xl hover:text-cyan-400 transition-colors">hello@void.fashion</a>
                </div>
            </div>
