export default function Header() {
    return (
        <header className="fixed top-0 w-full z-50 mix-blend-difference text-white p-6 flex justify-between items-center backdrop-blur-sm bg-transparent">
            <div className="text-3xl font-bold tracking-widest uppercase hover:text-cyan-400 transition-colors cursor-pointer flex items-center">
                <div className="relative group">
                    V
                    <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute" style={{ top: '-6px', left: '102px', width: '24px', height: '24px', rotate: '15deg' }}>
